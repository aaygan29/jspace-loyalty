...
def main() -> None:
    ...
    # The bound: largest residual effect that STILL yields ABSTAIN at least 20% of the
    # time. Anything up to this is consistent with the null result we observed, so a
    # null result cannot rule it out.
